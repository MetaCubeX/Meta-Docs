...
Значения поддерживают [маску доменов](../../handbook/syntax.md#domain-wildcards) и [импорт наборов доменов](../../handbook/syntax.md#introducing-domain-sets)
...
!!! warning ""
    Это поле устарело. Используйте [nameserver-policy](./index.md#nameserver-policy).
...
Изменяет только целевое имя DNSName для проверки сертификата, не меняя SNI.
