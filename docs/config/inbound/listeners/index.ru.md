...
Порт прослушивания, поддерживает формат ports, формат описан в [диапазонах портов](../../../handbook/syntax.md#port-ranges)

## routing-mark

Устанавливает routing-mark для прослушивающего сокета. Поддерживается только Linux
