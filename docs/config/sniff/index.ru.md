...
Список доменов для принудительного обнаружения, использует [подстановочные знаки доменов](../../handbook/syntax.md#domain-wildcards).

## skip-domain

Список доменов для пропуска обнаружения, использует [подстановочные знаки доменов](../../handbook/syntax.md#domain-wildcards).
