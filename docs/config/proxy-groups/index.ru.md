...
Интервал проверки работоспособности; если не равен 0, включается периодическое тестирование, измеряется в секундах. (Примечание: Этот параметр не имеет эффекта, если тип группы прокси — select.)
