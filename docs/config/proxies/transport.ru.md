...
Примечание: В отличие от оригинальной реализации, это поле допускает только отдельные числа; диапазоны не допускаются.
...
Это значение конфликтует с max-connections; можно выбрать только одно из них.
