...
Фильтрует узлы, соответствующие ключевым словам или [регулярным выражениям](https://github.com/ziishaned/learn-regex/blob/master/translations/README-ru.md). Вы можете использовать символ `` ` `` для разделения нескольких регулярных выражений.

## exclude-filter

Исключает узлы, соответствующие ключевым словам или [регулярным выражениям](https://github.com/ziishaned/learn-regex/blob/master/translations/README-ru.md) Вы можете использовать символ `` ` `` для разделения нескольких регулярных выражений.
